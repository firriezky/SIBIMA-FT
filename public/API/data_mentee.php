  ...
  <div style="margin:15px; align:center">
    <form class="searchy">
      <div class="a-field search__field">
        <input type="text" id="query" class="r-text-field a-field__input search__input" placeholder="Nim/Kelas/Jurusan" required>
  ...
  <div style="overflow-x:auto;margin:15px;">
    <table class=" table-responsive" id="tb_peserta" width="100%">
      ...
      <tbody id="tb_pesertax">
        ...
        if ($connect) {
          $call_database = mysqli_query($connect, "SELECT kelas,nim,nama,program_studi FROM mentee");
        } else {
