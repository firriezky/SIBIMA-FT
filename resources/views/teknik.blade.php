...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSenzve3TaWCWxOoBjNB7ImHAzJKbzBp_rEytXdO8hqToYE1kg/viewform?embedded=true" width="700" height="520" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
            ...
            <div class="login-card bg-text">
                <div class="card-block">
                    <div class="form-box" id="login-box">
                        ...
                        <a href=""><button  style="font-family: Quicksand"  class="btn btn-primary btn-block px-2">Fakultas Teknik (FT-FRI-FIF)</button></a>
                        <a href=""><button  style="font-family: Quicksand"  class="btn btn-primary btn-block mt-1 px-2">Fakultas Industri Kreatif (FIK)</button></a>
                        <a href=""><button  style="font-family: Quicksand"  class="btn btn-primary btn-block mt-1 px-2">Fakultas Ilmu Terapan (FIT)</button></a>
                        <a href=""><button  style="font-family: Quicksand"  class="btn btn-primary btn-block mt-1 px-2">FKEB</button></a>
