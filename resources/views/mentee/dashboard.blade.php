                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="intro" style="margin-bottom: 20px">
                                        ...
                                        <p class="text-xs-center"><span class="by">by</span> <a style="color: #00aced">Badan Mentoring Admin</a> | <span class="date"> {{ $pengumuman->created_at }} </span></p>
                                        <div class="m-b-2">
                                            {!! $pengumuman->detail !!}
                                        </div>
                                        @if($pengumuman->file_url != null)
                                        <img  class="mx-auto d-block img-fluid img-thumbnail"  src="{{ url($pengumuman->file_url)}}" >
                                        @endif
                                    </div>
                                </div>
                            </div>
