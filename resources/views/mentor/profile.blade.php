                ...
                <div class="profile-header-container">
                    <div class="text-xs-center">
                        @if (strtolower(Auth::guard('mentor')->user()->jk) == 1)
                            <img src="{{ url('img/avatar/avatar-sibima03.png') }}" class="img-fluid profile-user"
                                alt="Responsive image">
                        @else
                            <img src="{{ url('img/avatar/avatar-sibima02.png') }}" class="img-fluid profile-user"
                                alt="Responsive image">
                        @endif
                    </div>
                    <hr class="m-b-0">
                ...
                <div class="card-block">
                    <form action="{{ url('mentor/profile') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{ Auth::guard('mentor')->user()->nama }}"
                                class="form-control" disabled />
                        </div>
                        <div class="form-group">
                            <label class="control-label">Nomor HP</label>
                            <input name="nomor_hp" type="text" value="{{ Auth::guard('mentor')->user()->no_telp }}"
                                class="form-control" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">Group Kelompok</label>
                            <input name="id_line" type="text" value="{{ Auth::guard('mentor')->user()->line_id }}"
                                class="form-control" placeholder="Masukkan Link Group Anda" />
                        </div>
                        <div>
            ...
            <div class="card-block">
                <form action="{{ url('mentor/update-cred') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Contoh : BCA - 1234456654" class="form-control" required
                            name="no_rekening" id="" value="{{ Auth::guard('mentor')->user()->no_rekening }}"
                            aria-describedby="helpId" placeholder="Nomor Rekening">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" name="photo_ktp" id="" placeholder=""
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" name="photo_ttd" id="" placeholder=""
                            aria-describedby="fileHelpId">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" name="photo_ktm" id="" placeholder=""
                            aria-describedby="fileHelpId">
                        <small id="fileHelpId" class="form-text text-muted">Foto Kredensial KTM Mentor</small>
                    </div>
                    <div class="form-group">
                        <label for="">Upload/Edit Buku Tabungan</label>
                        <input type="file" class="form-control-file" name="photo_tabungan" id="" placeholder=""
                            aria-describedby="fileHelpId">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Buku Tabungan</td>
                            <td>
                                <img class="card-img-top img-fluid" style=" border-radius:20px !important"
                                    src="{{ url('/') . Auth::guard('mentor')->user()->path_rekening }}"
                                    alt="Card image cap"
                        ...
                        <tr>
                            ...
                            <td>
                                <img class="card-img-top img-fluid" style=" border-radius:20px !important"
                                    src="{{ url('/') . Auth::guard('mentor')->user()->path_ktp }}" alt="Card image cap"
                                    onerror="this.src='http://www.pallenz.co.nz/assets/camaleon_cms/image-not-found-4a963b95bf081c3ea02923dceaeb3f8085e1a654fc54840aac61a57a60903fef.png'">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <img class="card-img-top img-fluid" style=" border-radius:20px !important"
                                    src="{{ url('/') . Auth::guard('mentor')->user()->path_ktm }}" alt="Card image cap"
                                    onerror="this.src='http://www.pallenz.co.nz/assets/camaleon_cms/image-not-found-4a963b95bf081c3ea02923dceaeb3f8085e1a654fc54840aac61a57a60903fef.png'">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <img class="card-img-top img-fluid" style=" border-radius:20px !important"
                                    src="{{ url('/') . Auth::guard('mentor')->user()->path_ttd }}" alt="Card image cap"
                                    onerror="this.src='http://www.pallenz.co.nz/assets/camaleon_cms/image-not-found-4a963b95bf081c3ea02923dceaeb3f8085e1a654fc54840aac61a57a60903fef.png'">
                            </td>
                        </tr>
                    </tbody>
