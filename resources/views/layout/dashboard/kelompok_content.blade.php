<div class="row">
    ...
    <div class="col-md-12">
        <div class="input-group form-group">
            <span class="input-group-addon"><span class="fa fa-comment-o"></span>Line Mentor / Link Grup
                Mentoring</span>
            <div class="form-control form-head">
...
<div class="row mb-2">
    @if (Auth::guard('mentor'))
        <button id="{{ $kelompok->id }}" class="btn btn-success btn-gaji-mentor" type="button">Info Gaji
            Kelompok</button>
    @endif
</div>
