...
@section('title') Input Berita Mentoring [Telat] @endsection
...
@section('content')
    ...
    @elseif($list_kelompok->count() == 1)
        ...
        @foreach($list_kelompok as $kelompok)
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('admin/berita-mentoring/input') }}" method="post">
                        {{ csrf_field() }}
                        <input style="display: none" value="{{ $agenda->id }}" name="agenda_id">
