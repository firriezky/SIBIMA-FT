...
@section('js_addon')
	...
	<script>
		...
		$("#select-mentee").remoteChained({
			...
			url : "{{ url('admin/api/get-mentee-ikhwan') }}",
...
@section('content')
	...
	<nav class="breadcrumb">
		...
		<a class="breadcrumb-item">Buat Kelompok Ikhwan</a>
	</nav>

	@include('layout.dashboard.alert_flash')

	<div class="card card-block">
		<h4 class="card-title">Buat Kelompok Ikhwan</h4>
		<hr>
		<form class="form" action="{{ url('admin/kelompok/create-ikhwan') }}" method="post"
			  id="form-create-kelompok-ikhwan">
